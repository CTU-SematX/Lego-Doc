...
See [Creating Blocks Guide](blocks.md) for detailed instructions.
...
See [Writing Plugins Guide](plugins.md) for details.
...
4. **Docs Site** - Add to MkDocs documentation
...
See [CONTRIBUTING.md](https://github.com/CTU-SematX/LegoCity/blob/main/CONTRIBUTING.md) for:
